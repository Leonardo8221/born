...
const ProductHeader: FC<ProductHeaderProps> = ({
  ...
  const handleOnEdit = () => {
    localStorage.setItem('edit_product_back_link', router.asPath);
    router.push(
      `/organization/${organizationId}/discover/products/${productId}/edit`
    );
  };
  ...
  return (
    <>
      <div
        className={clsx(
          'sticky top-0 z-[10] bg-shades-white mx-auto p-6',
          containerClassName
        )}
      >
