  ...
  return (
    <div className='flex flex-wrap gap-8'>
      ...
      <div className='w-full max-w-[352px]'>
        ...
        <div>
          {tags?.map((tag: any) => (
            <div key={tag.title} className={clsx('flex mt-6 flex-wrap gap-x-4', (tag?.list?.length > 1) ? '' : 'items-center')}>
        ...
        <div className='mt-6'>
          {specifications?.map(item => (
            <div key={item.value + item.label} className='flex itms-center py-[6px] gap-x-4'>
