export const buttonVariants = {
  black: "bg-shades-black text-shades-white",
  white: "bg-shades-white text-shades-black",
  accent: "bg-accent-a-200 text-shades-white",
  neutral: "bg-neutral-400 text-shades-white",
};
...
export const buttonSize = {
  sm: "text-xs py-0 px-4 h-8",
  md: "text-sm py-0 px-5 h-9",
  lg: "text-base py-0 px-6 h-10",
};
