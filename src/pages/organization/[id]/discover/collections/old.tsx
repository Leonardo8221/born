...
import ToggleCollectionSection from '@/components/page-components/common/ToggleCollectionSection';
  ...
  return (
    <div>
      ...
      >
        ...
        <Filters
          onGridChange={(type: GridType) => {setGrid(type); setIsCollectionSection(false)}}
          gridType={gridType}
        ...
        >
          {gridType !== 'list' ? (
            <div className="flex border-r border-neutral-400 pr-4 mr-4">
              <ToggleCollectionSection
                showSection={isCollectionSection}
                onChange={() => setIsCollectionSection(!isCollectionSection)}
              />
            </div>
          ): undefined}
        </Filters>
